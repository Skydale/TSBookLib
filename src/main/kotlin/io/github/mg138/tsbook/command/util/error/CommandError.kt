...
object CommandError {
    fun handEmpty(sender: CommandSender) {
        sender.sendMessage(BookConfig.translate.get("errors.hand_empty"))
    }

    fun noSuchOption(sender: CommandSender) {
        sender.sendMessage(BookConfig.translate.get("errors.no_such_option"))
    }

    fun shouldPutNumber(sender: CommandSender) {
        sender.sendMessage(BookConfig.translate.get("errors.should_put_number"))
    }

    fun itemNotFound(sender: CommandSender) {
        sender.sendMessage(BookConfig.translate.get("errors.item_not_found"))
    }

    fun playerNotFound(sender: CommandSender) {
        sender.sendMessage(BookConfig.translate.get("errors.player_not_found"))
    }
