...
import io.github.mg138.tsbook.players.data.ItemStackMapWrapper
...
class ItemStackVectorAdapterPair: SystemLevel, TypeAdapterPair {
    class ItemStackVectorTypeAdapter : TypeAdapter<ItemStackMapWrapper?>() {
    ...
    override val type: Type = ItemStackMapWrapper::class.java
