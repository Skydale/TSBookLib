...
public class ItemInstance { //represents a single ItemStack
    private static final Map<UUID, ItemInstance> instances = new HashMap<>();
    private static final PersistentDataType<byte[], UUID> uuidTagType = new UUIDTagType();
    private static final NamespacedKey KEY = new NamespacedKey(Book.getInst(), "item");
    ...
    public ItemStack createItem() {
        ...
        container.set(KEY, PersistentDataType.STRING, configuration.getString("ID"));
