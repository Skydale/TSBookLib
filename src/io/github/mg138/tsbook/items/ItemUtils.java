...
import io.github.mg138.tsbook.items.data.Identification;
...
public class ItemUtils {
    ...
    public static ItemStack createItem(JavaPlugin plugin, ItemInstance inst, String type) {
        ...
        if (config.contains("ITEM_TYPE")) {
            container.set(new NamespacedKey(plugin, "type"), PersistentDataType.STRING, Objects.requireNonNull(config.getString("ITEM_TYPE")));
            //SET ITEM TYPE
        }
